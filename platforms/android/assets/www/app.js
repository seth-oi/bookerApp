...
.controller('MainController', ['$scope', '$timeout', '$rootScope', '$location', '$interval', 'booker.service.book.BookerService', function($scope, $timeout, $rootScope, $location, $interval, BookerService){
  ...
  $interval(function(){
    if(($location.path()).substr(1,8) == 'services')
    {
      $rootScope.showProceed = true;
    }
    else{
      $rootScope.showProceed = false;
    }
  }, 1000);
...
phonecatApp.config(function($routeProvider, selectionModelOptionsProvider) {
    ...
    $routeProvider.
      ...
      when('/locationDirection', {
        templateUrl: './features/locations/locationsDirections.html',
        controller: 'locationDirectionController'
      }).
      when('/login', {
      ...
      when('/forgotPassword', {
        templateUrl: './features/forgotPassword/forgotPassword.html',
